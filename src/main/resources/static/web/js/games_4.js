...
function getGameItem(gameData, userData){
    ...
    if (idPlayerInGame != -1)
        item = '<li class="list-group-item"><a href="game_2.html?gp='+ idPlayerInGame + '">'+ new Date(gameData.crationDate).toLocaleString() + ' ' + gameData.gamePlayers.map(function(p) { return p.player.userName}).join(', ')  +'</a></li>';
    return item;
}
